          ...
          <>
            <Reveal as="section" className="ann ann--wide exp-section" id="adn">
              ...
              <div className="exp-metrics">
                <div><strong>{data.dna.loyalty}%</strong><span>fidélité</span><small>écoutes d’artistes suivis sur au moins trois mois</small></div>
                <div><strong>{data.dna.curiosity}%</strong><span>curiosité</span><small>artistes récents découverts pendant la période</small></div>
                <div><strong>{data.dna.replay}%</strong><span>répétition</span><small>écoutes qui reviennent sur un titre déjà lancé</small></div>
                <div><strong>{data.dna.night}%</strong><span>nuit</span><small>écoutes enregistrées entre minuit et six heures</small></div>
              </div>
            </Reveal>
            ...
            <Reveal as="section" className="ann ann--wide exp-section" id="wrap">
              ...
              <div className="wrap-lead">
                <strong>{nf(wrap.scrobbles)}</strong>
                <span>scrobbles</span>
            ...
            <Reveal as="section" className="ann ann--wide exp-section" id="match">
              ...
              {match && (
                <div className="match-result">
                  <div className="match-score"><strong>{match.score}%</strong><span>avec {match.username}</span></div>
                  <div className="exp-split">
